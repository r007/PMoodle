...
/**
 * Strings for component 'admin', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   admin
...
$string['allowbeforeblock'] = 'Начать со списка разрешённых адресов';
$string['allowbeforeblockdesc'] = 'По умолчанию сначала проверяется список заблокированных адресов. Если эта опция включена, адреса будут сначала проверяться по списку разрешённых IP-адресов.';
...
$string['allowediplist'] = 'Список разрешённых IP-адресов';
$string['allowemailaddresses'] = 'Разрешённые почтовые домены';
...
$string['authpreventaccountcreation'] = 'Предотвратить создание учётной записи при аутентификации';
$string['authpreventaccountcreation_help'] = 'Во время аутентификации пользователя автоматически создаётся учётная запись, если таковой ещё не существует. Если для аутентификации используется внешняя база данных, такая как LDAP, но Вы хотите ограничить доступ к сайту только пользователям с существующей учётной записью, то следует включить этот параметр. В этом случае новые учётные записи должны быть созданы вручную или через  функцию загрузки пользователей. Обратите внимание, что этот параметр не относится к аутентификации MNet.';
...
$string['calendarexportsalt'] = 'Мусорная последовательность для экспорта календаря';
...
$string['clistatusdisabled'] = 'Статус: отключено';
...
$string['configauthenticationplugins'] = 'Выберите плагины аутентификации, которые Вы хотите использовать и упорядочите их в соответствие с очерёдностью проверки.';
...
$string['configconvertformat'] = 'Если доступны <i>latex</i>, <i>dvips</i> и <i>convert</i>, то изображения создаются в указанном формате. Если их нет, то будет использоваться mimeTeX, который создаёт GIF-изображения.';
...
$string['configdeleteunconfirmed'] = 'Если у Вас используется самостоятельная регистрация по электронной почте, то пользователь сможет подтвердить свою учётную запись в течение указанного периода. По окончании этого периода все неподтверждённые учетные записи будут автоматически удалены.';
...
$string['configenablewebservices'] = 'Веб-службы позволяют другим системам подключаться к Moodle и выполнять некоторые операции. Для повышения уровня безопасности эту функция не следует включать, если Вы ей не пользуетесь.';
...
$string['configgetremoteaddrconf'] = 'Если Ваш сервер находится за реверсивным прокси-сервером, этот параметр указывает, какой именно из заголовков HTTP содержит IP-адрес удалённого компьютера. Заголовки просматриваются в указанном порядке, используется первый доступный.';
...
$string['configintroadmin'] = 'На этой странице Вам необходимо настроить учётную запись основного администратора, имеющего полный контроль над сайтом. Убедитесь, что Вы указали безопасный логин и пароль, а также корректный адрес электронной почты. Позже Вы сможете добавить других администраторов.';
...
$string['configprofilesforenrolledusersonly'] = 'Для предотвращения злоупотребления спамерами описания профилей пользователей, которые ещё не записаны ни на один курс, скрыты. Новые пользователи должны записаться хотя бы на один курс, прежде чем смогут заполнить в профиле поле "Описание".';
...
$string['configproxybypass'] = 'Список имён узлов сети и IP-адресов (или их частей) для доступа к которым не нужен прокси-сервер (например, "192.168., .mydomain.com")';
...
$string['configstatsfirstrun'] = 'Этим параметром определяется, записи системного журнала за какой срок будут обработаны при <b>в первом</b> запуске cron для подсчёта статистики. Если у Вас нагруженный сервер и используется совместный хостинг, возможно не стоит устанавливать слишком большое значение, поскольку работа cron может быть продолжительной и использовать много ресурсов. (Обратите внимание, что для этого параметра 1 месяц = 28 дней. В генерируемых графиках и отчетах 1 месяц = 1 календарный месяц).';
...
$string['configstatsuserthreshold'] = 'Этот параметр определяет минимальное число записанных на курс пользователей необходимое, чтобы курс был учтён при подсчёте статистики.';
...
$string['configuseexternalyui'] = 'Использовать онлайн-версии файлов, доступные на серверах Yahoo, вместо локальных версий. ВНИМАНИЕ: Для этого требуется подключение к интернету иначе на Вашем сайте не будет работать AJAX. Этот параметр несовместим с сайтами, доступными по протоколу https.';
...
$string['configverifychangedemail'] = 'Включить проверку по списку разрешённых и запрещённых доменов при изменении пользователем адреса электронной почты. Если отключить этот параметр, адреса будут проверяться только при создании новых учётных записей.';
...
$string['courselistshortnames'] = 'Отображать краткие названия';
$string['courselistshortnames_desc'] = 'При отображении списка курсов выводить не только полные, но и краткие названия.';
...
$string['creatornewroleid_help'] = 'Если у пользователя, создавшего курс, ещё нет права на управление новым курсом, то он получит эту роль в рамках курса.';
$string['cron'] = 'Cron';
...
$string['enablegravatar_help'] = 'При включении этого параметра Moodle будет пытаться использовать изображение пользователя с сервера Gravatar, если пользователь не загрузил своё изображение.';
$string['enablegroupmembersonly'] = 'Включить параметр "Только для членов группы"';
$string['enablemobilewebservice'] = 'Включить мобильную веб-службу';
...
$string['environmentshouldfixsetting'] = 'Стоит изменить параметр PHP.';
...
$string['helpupcominglookahead'] = 'На сколько дней вперёд, по умолчанию, нужно выводить предстоящие события?';
...
$string['loginpasswordautocomplete'] = 'Отключить автозаполнение пароля в форме входа в систему';
$string['loginpasswordautocomplete_help'] = 'При отключении этого параметра пользователи смогут сохранять пароли в браузере. Включение этого параметра приведёт к тому, что сайт не будет соответствовать стандарту XHTML strict';
...
$string['mnetrestore_extusers_switchuserauth'] = 'Внешиний пользователь "{$a->username}" из Moodle Network (пришёл с {$a->mnethosturl}) переключен на внутреннюю аутентификацию "{$a->auth}".';
...
$string['navcourselimit'] = 'Предел числа курсов';
...
$string['navlinkcoursesections'] = 'Ссылки на разделы курсов';
$string['navlinkcoursesections_help'] = 'При включении этого параметра разделы курсов в блоке навигации будут отображаться в виде ссылок.';
...
$string['nohttpsformobilewarning'] = 'Рекомендуется включить HTTPS с действующим сертификатом. Приложение Moodle всегда будет в первую очередь пытаться использовать защищённое соединение.';
...
$string['opensslrecommended'] = 'Настоятельно рекомендуется установка дополнительной библиотеки OpenSSL - от неё зависит функционирование Moodle Networking.';
...
$string['profilingallowme_help'] = 'При включении этого параметра Вы затем, выборочно, сможете использовать параметр PROFILEME в любом месте (PGS) и произойдёт профилирование этого скрипта. Аналогично, Вы сможете использовать параметр DONTPROFILEME  для предотвращения профилирования.';
...
$string['settingfileuploads'] = 'Для нормальной работы требуется возможноть загрузки файлов на сервер, включите её в настройках PHP.';
...
$string['sitemaintenancewarning2'] = 'Ваш сайт в настоящее время в режиме технического обслуживания (вход только для администраторов). Для возврата сайта в нормальный режим работы <a href="maintenance.php"> отключите режим обслуживания </a>';
...
$string['sitesectionhelp'] = 'Если параметр включен, то отображен на главной странице сайта будет отображаться раздел описания.';
...
$string['stickyblocks'] = 'Закреплённые блоки';
...
$string['suspenduser'] = 'Учётная запись заблокирована';
...
$string['themeselect'] = 'Выберите тему';
...
$string['unicoderecommended'] = 'Рекомендуется хранить все Ваши данные в Unicode (UTF-8). Новые установки должны производиться с базой данных именно с таким набором символов по умолчанию. При обновлении, необходимо выполнить процесс преобразования в UTF-8 (см. страницу Администрирование).';
$string['unicoderequired'] = 'Обязательно хранить все Ваши данные в Unicode (UTF-8). Новые установки должны производиться с базой данных именно с таким набором символов по умолчанию. При обновлении, необходимо выполнить процесс преобразования в UTF-8 (см. страницу Администрирование).';
...
$string['upgradinglogs'] = 'Обновление отчётов (logs)';
$string['upgradingversion'] = 'Обновление до новой версии';
$string['upwards'] = 'актуальная';
