...
/**
 * Strings for component 'block', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   block
...
$string['appearsinsubcontexts'] = 'Отображаются в подчинённых контекстах';
...
$string['contexts_help'] = 'Контексты конкретных типов страниц, где этот блок может быть отображен в своём исходном расположении. Вы будете иметь различные варианты в зависимости от исходного расположения блока и своего текущего местонахождения.
...
$string['defaultregion_help'] = 'Темы могут определять одну или несколько областей названных блоков, где блоки будут отображаться. Этот параметр определяет, в какой из них Вы хотите по умолчанию отображать блок. При необходимости его расположение на конкретных страницах может быть изменено.';
...
$string['moveblockhere'] = 'Переместить блок сюда';
$string['movingthisblockcancel'] = 'Перемещение этого блока ({$a})';
$string['onthispage'] = 'На этой странице';
$string['pagetypes'] = 'Типы страниц';
$string['pagetypewarning'] = 'Больше нет возможности выбирать указанный ранее тип страницы. Выберите наиболее подходящий тип страницы из приведённых ниже.';
