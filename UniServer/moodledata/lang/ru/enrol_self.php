...
/**
 * Strings for component 'enrol_self', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol_self
...
$string['enrolenddaterror'] = 'Дата окончания записи не может быть ранее даты её начала';
...
$string['longtimenosee_help'] = 'Если пользователь долго не заходил на курс, то он будет автоматически исключён через заданный период времени.';
...
$string['passwordinvalid'] = 'Неверное кодовое слово, попробуйте ещё раз';
$string['passwordinvalidhint'] = 'Введено неверное кодовое слово, попробуйте ещё раз<br />(Подсказка - оно начинается с \'{$a}\')';
$string['pluginname'] = 'Самостоятельная запись';
$string['pluginname_desc'] = 'Плагин самостоятельной записи позволяет пользователям самостоятельно записываться на желаемый курс. Курсы могут быть защищены кодовым словом. Внутри системы запись пользователя выполняется через модуль "Зачисление вручную", поэтому он должен быть включён для работы данного модуля.';
...
Если Вы ещё не сделали этого, то отредактируйте свой профиль так, чтобы мы узнали больше о Вас:
