...
/**
 * Strings for component 'question', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   question
...
$string['behaviourbeingused'] = 'используется режим: {$a}';
...
$string['cannotdeletemissingbehaviour'] = 'Вы не можете удалить режим, так как он нужен системе.';
...
$string['changepublishstatuscat'] = 'Для категории <a href="{$a->caturl}">"{$a->name}"</a> в курсе "{$a->coursename}" будет изменён статус совместного использования со значения <strong>{$a->changefrom}</strong> на <strong>{$a->changeto}</strong>.';
...
$string['deletebehaviourareyousure'] = 'Вы уверены, что хотите удалить режим "{$a}"?';
$string['deletebehaviourareyousuremessage'] = 'Вы собираетесь полностью удалить режим вопроса "{$a}". Это полностью удалит из базы данных всё, что связано с этим режимом вопроса. Вы действительно хотите это сделать?';
...
$string['deleteqtypeareyousuremessage'] = 'Вы собираетесь полностью удалить тип вопроса "{$a}". Это действие полностью удалит из базы данных все данные, связанные с удаляемым типом вопроса. Вы уверены, что продолжить операцию?';
...
$string['didnotmatchanyanswer'] = '[Не найдено ни одного ответа]';
...
$string['exportquestions_help'] = 'Эта функция позволяет экспортировать в текстовый файл вопросы всей категории (и любых её подкатегорий).
...
$string['generalfeedback_help'] = 'Общий отзыв отображается студенту после того, как он попытался ответить на вопрос. В отличие от отзыва, который зависит от типа вопроса и ответа, данного студентом, всем студентам отображается одинаковый текст общего отзыва.
...
$string['qbehaviourdeletefiles'] = 'Все данные режима "{$a->behaviour}" удалены из базы данных. Для полного удаления (и предотвращения повторной установки режима) удалите с сервера папку: {$a->directory}';
...
$string['questionidmismatch'] = 'Несовпадение идентификаторов вопроса';
...
$string['questionsmovedto'] = 'Всё ещё использующиеся вопросы перемещены в "{$a}" в родительской категории курса.';
$string['questionsrescuedfrom'] = 'Вопросы, сохраненые из контекста "{$a}".';
$string['questionsrescuedfrominfo'] = 'Эти вопросы (некоторые из которых возможно скрыты) были сохранены при удалении контекста "{$a}", потому что они всё ещё используются некоторыми тестами или другими элементами курсов.';
...
$string['showmarkandmax'] = 'Показывать оценку и максимум';
$string['showmaxmarkonly'] = 'Показывать только максимальную оценку';
...
$string['specificfeedback'] = 'Особый отзыв к вопросу';
...
$string['submissionoutofsequence'] = 'Доступ не по порядку. Пожалуйста, не нажимайте кнопку Назад, когда работаете над вопросами теста.';
...
$string['unknownquestioncatregory'] = 'Неизвестная категория вопросов: {$a}.';
