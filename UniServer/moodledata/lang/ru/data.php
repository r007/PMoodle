...
/**
 * Strings for component 'data', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   data
...
$string['exportaszip_help'] = '<p>Эта возможность позволяет Вам скачать шаблоны на компьютер, которые позже могут быть загружены в базу данных импортом из ZIP-архива.</p>';
$string['exportedtozip'] = 'Экспортировано во временный ZIP...';
$string['failedpresetdelete'] = 'Ошибка удаления предустановки!';
...
$string['fieldmappings_help'] = '<h2>Размещение полей</h2>
<p> Это меню позволяет вам сохранять данные из существующей
базы данных. Чтобы сохранить данные в новом поле, вы должны выбрать значение в новом
поле из списка данных. Любое поле можно оставить пустым, без информации. Любое старое поле, не отображенное в новом, будет потеряно и все данные удалены. </p>
Вы можете выбирать поля только того же самого типа, таким образом каждое всплывающее поле будет иметь различные поля. Не пытайтесь отображать одно старое поле к более, чем одному новому полю.
</p>';
...
$string['fromfile_help'] = 'Функция импорта из ZIP-архива позволяет просматривать и загружать данные шаблонов и полей из ZIP-файла.';
...
$string['maxentries_help'] = '<h2>Максимум записей</h2>
<p> Максимальное число записей, разрешенное для участника. </p>';
...
$string['requireapproval_help'] = '<h2>Требование одобрения</h2><p>Должны ли записи быть одобрены учителем перед тем, как показывать их ученикам? Это удобно для фильтрации бесполезного содержимого.</p>';
$string['requiredentries'] = 'Требуется записей';
$string['requiredentries_help'] = '<p>Необходимое количество записей должно быть подтверждено. Пользователь получит уведомление, когда достигнет необходимого количества записей.</p>

<p>Деятельность будет ограниченной, если пользователь не представит необходимое количество записей.</p>';
$string['requiredentriestoview'] = 'Требуется записей до разрешения просмотра';
$string['requiredentriestoview_help'] = '<h2>Требование записей перед просмотром Базы</h2>

<p>Количество своих записей, которые участник обязан сделать прежде, чем ему будет разрешен просмотр любых записей этой базы данных.</p>';
...
$string['saveaspreset_help'] = '<h2>Сохранение заготовок</h2>
<p>Эта возможность сохраняет шаблон как заготовку с предварительными настройками, которые сможет использовать любой человек на сайте. Они доступны в списке заготовок. Вы сможете убрать их в любое время.</p>';
...
$string['subplugintype_datapreset_plural'] = 'Предустановки';
...
$string['usestandard_help'] = '<h2>Использование заготовок</h2>
<p>
Этот шаблон доступен для использования на всем сайте.</p>
<p>
Если вы добавили его в библиотеку, используя кнопку "Сохранить как заготовку", то позже вы можете удалить его.
</p>';
