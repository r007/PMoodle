...
/**
 * Strings for component 'quiz', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   quiz
...
$string['addnewpagesafterselected'] = 'Добавить новые страницы после выбранных ответов';
...
$string['attemptstillinprogress'] = 'Попытка еще выполняется';
...
$string['cannotstartgradesmismatch'] = 'Не удалось начать попытку тестирования. Тест должен оцениваться в {$a->grade}, но ни один из вопросов не имеет оценки. Это может быть исправлено на странице "Редактировать тест".';
$string['cannotstartmissingquestion'] = 'Не удалось начать попытку тестирования. Тест включает в себя вопрос, который не существует.';
$string['cannotstartnoquestions'] = 'Не удалось начать попытку тестирования. Тест еще не настроен и не добавлены вопросы.';
...
$string['configshufflewithin'] = 'Если вы включите этот параметр, то части, составляющие отдельные вопросы, будут располагаться в случайном порядке при каждой попытке пройти тест, при условии, что этот параметр также включен в настройках вопроса.';
...
$string['howquestionsbehave_desc'] = 'Настройка по умолчанию';
...
$string['missingquestion'] = 'Похоже, что этот вопрос уже не существует';
...
$string['notenoughrandomquestions'] = 'Недостаточно вопросов в категории {$a->category} для создания вопроса {$a->name} ({$a->id}).';
...
$string['notyetviewed'] = 'Еще не просмотрено';
...
$string['orderandpaging_help'] = 'Номерами 10, 20, 30, ... напротив вопросов указывают на порядок вопросов. Номера увеличиваются с шагом 10, чтобы оставить место для дополнительных вопросов, которые могут быть вставлены. Чтобы изменить порядок вопросов, измените их номера и нажмите кнопку "Изменить порядок вопросов".
...
$string['rqp'] = 'Отдалённый вопрос';
$string['rqps'] = 'Отдалённые вопросы';
...
$string['savingnewgradeforquestion'] = 'Сохранение новой оценки для вопроса с идентификатором {$a}.';
...
$string['showeachpage'] = 'Показывать одну страницу за раз';
...
$string['startnewpreview'] = 'Начать новый обзор';
...
$string['subnetnotice'] = 'Этот тест доступен только на некоторых компьютерах. Ваш компьютер не находится в разрешённой зоне. Тем не менее, поскольку Вы являетесь учителем, вы можете просмотреть тест.';
...
$string['updatingthegradebook'] = 'Обновление журнала.';
