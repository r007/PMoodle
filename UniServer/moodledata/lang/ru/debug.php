...
/**
 * Strings for component 'debug', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   debug
...
$string['configmoodle'] = 'Moodle ещё не настроен. В первую очередь Вам необходимо отредактировать config.php.';
...
$string['mustbeoveride'] = 'Абстрактный метод "{$a}" должен быть переопределён.';
...
$string['noreports'] = 'Не доступен ни один отчёт';
