...
/**
 * Strings for component 'gradereport_outcomes', language 'ru', branch 'MOODLE_22_STABLE'
 *
...
$string['outcomes:view'] = 'Просматривать отчёт по показателям';
$string['pluginname'] = 'Отчёт по показателям';
