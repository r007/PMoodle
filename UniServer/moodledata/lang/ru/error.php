...
/**
 * Strings for component 'error', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   error
...
$string['cannotfinddocs'] = 'Не удаётся найти файлы  документации на языке "{$a}"';
...
$string['cannotviewreport'] = 'Вы не можете просматривать этот отчёт';
...
$string['couldnotassignrole'] = 'Серьёзная, но неопределенная ошибка произошла при попытке назначить Вам роль';
...
$string['dbsessionbroken'] = 'Обнаружена серьёзная проблема  сессии базы данных.<br /><br /> Пожалуйста, сообщите об этом администратору сервера.';
...
$string['dbsessionmysqlpacketsize'] = 'Обнаружена серьёзная ошибка сессии.<br /><br />Пожалуйста, сообщите об этом администратору сервера. Эта проблема, скорее всего, вызвана слишком маленьким значением max_allowed_packet  параметров MySQL.';
...
$string['expiredkey'] = 'Срок действия ключа истёк';
...
$string['importformatnotimplement'] = 'К сожалению, импорт в этом формате ещё не реализован!';
...
$string['maxbytes'] = 'Этот файл больше максимального разрешённого размера';
...
$string['moduledisable'] = 'Этот модуль ({$a}) был отключён в этом курсе';
...
$string['noparticipatorycms'] = 'Извините, нет модулей курса с участниками, нечего выводить в отчёте';
...
$string['prefixcannotbeempty'] = '<p>Ошибка: префикс имён таблиц базы данных не может быть пустым ({$a})</p><p>Администратор сайта должен решить эту проблему.</p>';
$string['prefixtoolong'] = '<p>Ошибка: префикс имён таблиц таблиц базы данных слишком длинный ({$a->dbfamily})</p> <p>Администратор сайта должен решить эту проблему. Максимальная длина префикса таблицы для {$a->dbfamily} должна быть {$a->maxlength} символов(а).</p>';
...
$string['reportnotavailable'] = 'Этот тип отчёта доступен только для курса уровня сайта';
$string['requireloginerror'] = 'Курс или элемент курса не доступны.';
$string['restorechecksumfailed'] = 'Некоторые проблемы произошли при  восстановлении данных сессии. Пожалуйста проверьте в своём PHP ограничения размера памяти/пакета базы данных. Восстановление остановлено.';
...
$string['sessionerroruser'] = 'Время Вашего сеанса истекло. Пожалуйста, войдите в систему ещё раз.';
...
$string['upgraderequires19'] = 'Ошибка: Новая версия Moodle была установлена на сервере, к сожалению, обновление с предыдущей версии не поддерживается.<br />Сначала обновите до последней версии 1.9.x. Вы также можете вернуться к предыдущей версии путём переустановки оригинальных файлов.';
$string['upgraderunning'] = 'Сайт обновляется, повторите попытку позже.';
$string['urlnotdefinerss'] = 'Для RSS-ленты не указан адрес';
$string['useradmineditadmin'] = 'Только администраторы могут изменять учётные записи других администраторов.';
$string['useradminodelete'] = 'Учётная запись администратора не может быть удалена';
...
$string['usernotdeletedadmin'] = 'Пользователь не удалён - нельзя удалять учётные записи администраторов';
...
$string['userquotalimit'] = 'Вы достигли предела квоты на объём личных файлов.';
