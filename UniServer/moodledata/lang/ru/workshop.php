...
/**
 * Strings for component 'workshop', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   workshop
...
$string['aggregation'] = 'Расчёт итоговой оценки';
...
$string['clearassessmentsconfirm'] = 'Вы уверены, что хотите удалить все баллы за оценивание? Вы не сможете вернуть свои собственные оценки, а рецензенты должны будут заново оценить размещённые работы.';
...
$string['err_multiplesubmissions'] = 'При редактировании этой формы был сохранён еще один вариант работы. Несколько представленных работ одного пользователя не допускается.';
$string['err_removegrademappings'] = 'Не удалось удалить отображения неиспользованных оценок';
...
$string['examplesbeforeassessment'] = 'Примеры доступны после представления собственной работы и должны быть оценены до оценивания работ сокурсников.';
...
$string['strategy_help'] = 'Стратегия оценки определяет используемую форму оценки и методы оценивания работ.
Есть 4 варианта:

* Совокупная оценка - комментарии и оценки даются в отношении указанных критериев
* Комментарии - комментарии даются в отношении указанных аспектов, но оценка не может быть выставлена
* Количество ошибок - комментарии и оценки да/нет даются в отношении указанных утверждений
* Рубрика - уровень оценки дается относительно определённых критериев';
...
$string['undersetup'] = 'В настоящее время семинар  настраивается. Пожалуйста, подождите, пока он перейдёт в следующую фазу.';
$string['useexamples'] = 'Использовать примеры';
$string['useexamples_desc'] = 'Примеры работ предоставляются для тренировки в оценивании.';
$string['useexamples_help'] = 'Если параметр включён, то пользователи могут попробовать оценить один или несколько представленных примеров и сравнить свои оценки с рекомендуемыми оценками. Эти оценки не учитываются в оценке за оценивание.';
...
$string['usepeerassessment_help'] = 'Если параметр включён, то пользователь может оценить работы, представленные другими сокурсниками, и получит баллы за оценивание в дополнение к оценке за собственную работу.';
$string['userdatecreated'] = 'представлено: <span>{$a}</span>';
$string['userdatemodified'] = 'изменено: <span>{$a}</span>';
$string['userplan'] = 'План семинара';
$string['userplan_help'] = 'План семинара отображает все его фазы и списки задач для каждой фазы. Текущая фаза будет выделена и завершённые задачи помечены галочкой.';
...
$string['useselfassessment_help'] = 'Если параметр включён, то
