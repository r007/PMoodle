...
/**
 * Strings for component 'hotpot', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   hotpot
...
$string['clickreporting'] = 'Включить отчёт о кликах';
$string['clues'] = 'Ключи';
...
$string['navigation_embed'] = 'Внедрённая веб-страница';
...
**Внедрённая веб-страница**
Панель навигации Moodle будет отображаться в тесте Hot Potatoes, внедрённом в страницу.
...
**Отсутствует**
Тест будет отображаться вообще без средств навигации. Когда будет получен ответ на все вопросы в текущем тесте, Moodle или вернётся к странице курса или перейдёт к следующему тесту, в зависимости от установки "Показать следующий тест?" для текущего теста.';
