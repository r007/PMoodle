...
/**
 * Strings for component 'message_email', language 'ru', branch 'MOODLE_22_STABLE'
 *
...
$string['configsitemailcharset'] = 'Вся электронная почта с Вашего сайта будет отправляться  в указанной здесь кодировке. При этом каждый пользователь сможет изменить её, если будет включён следующий параметр.';
