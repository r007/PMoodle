...
/**
 * Strings for component 'glossary', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   glossary
...
$string['casesensitive_help'] = '<h2>Соответствие чувствительно к регистру</h2>

<p>Эта настройка определяет, необходимо ли  точное совпадение с учетом  регистра при выполнении   автоматического связывания с записью.</p>

<p>Если эта опция включена, то, например, слово "html"  в сообщении форума не будет связываться  с записью глоссария, названной "HTML".</p>';
...
$string['cnflinkglossaries'] = 'По умолчанию глосарии должны быть с включённым автосвязыванием';
...
$string['filetoimport_help'] = 'Выберите на своём компьютере XML-файл, содержащий записи для импорта.';
