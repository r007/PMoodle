...
/**
 * Strings for component 'bulkusers', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   bulkusers
...
$string['selectedlist_help'] = 'Пользователи могут быть добавлены или удалены из списка выбранных пользователей. Для этого щёлкните на именах пользователей и нажмите соответствующую кнопку. Чтобы выбрать несколько пользователей, щёлкните на именах пользователей, удерживая клавишу Ctrl или Apple.';
