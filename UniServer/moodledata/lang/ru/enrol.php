...
/**
 * Strings for component 'enrol', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol
...
$string['enroltimeend'] = 'Окончание записи';
$string['enroltimestart'] = 'Начало записи';
...
$string['extremovedaction_help'] = 'Выберите действие, выполняемое при исчезновении пользователя из внешнего источника записи на курс. Пожалуйста, обратите внимание, что из курса удаляются некоторые настройки  и данные пользователя при исключении его из курса.';
...
$string['unenrolme'] = 'Исключить себя из {$a}';
