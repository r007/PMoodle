...
/**
 * Strings for component 'moodle', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
{$a->extendurl}';
$string['expirynotify_help'] = '<p>Уведомлять об окончании регистрации?</p>';
...
$string['groupmodeforce_help'] = '<h2>Принудительный групповой режим</h2>
...
<p>Это полезно, например, если необходимо создать курс
   для нескольких полностью отдельных групп.</p>';
$string['groupmode_help'] = '<h2>Групповой режим</h2>

<p>Вы можете выбрать один из трех групповых режимов:
   <ul>
      <li>Нет групп - ученики не делятся на группы, каждый является частью одного большого сообщества.</li>
      <li>Отдельные группы - ученикам каждой группы кажется, что их группа - единственная, работа учеников других групп для них не видна.</li>
      <li>Доступные группы - ученики каждой группы работают только в пределах своей группы, но могут видеть, что происходит в других группах.</li>
   </ul>
</p>
...
<dl>
   ...
   <dd>Для каждого элемента, поддерживающего групповой режим, можно
	   ...
	   "<a href="help.php?module=moodle&file=groupmodeforce.html">принудительный групповой режим</a>", то установки любого элемента курса игнорируются.</dd>
</dl>';
...
$string['idnumbercourse_help'] = '<h2>Идентификационный номер курса</h2>
...
$string['newsitemsnumber_help'] = 'Этот параметр определяет, количество пунктов в блоке "Последние новости" на странице курса. Если установить значение "0 новостей", то этот блок не будет отображаться.';
...
$string['separatedandconnectedinfo'] = 'Сообщения могут оцениваться, использую шкалу, основанную на теории <strong>объективного и субъективного познания</strong>.
...
В каждой конкретной ситуации, например в форумах, постарайтесь оценить сообщения учеников, исходя из этих двух критериев. Возможно, это сможет помочь вам понять каждого из учеников и создать хорошую атмосферу для обучения.
