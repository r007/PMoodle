...
class admin_setting {
    ...
    function config_read($name) {
        global $CFG;
        if ($this->plugin === 'backup' or $this->plugin === 'incrementalbackup') {
...
class admin_setting_special_backupincdays extends admin_setting_configmulticheckbox2 {
    function admin_setting_special_backupincdays() {
        parent::admin_setting_configmulticheckbox2('backup_inc_weekdays', get_string('schedule'), get_string('backupschedulehelp'), array(), NULL);
        $this->plugin = 'backup';
    }
