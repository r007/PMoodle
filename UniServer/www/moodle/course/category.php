<?php // $Id$
    ...
    $deletecourses = optional_param('deletecourses', 0, PARAM_BOOL);
...
/// Editing functions
    ...
    /// Move a specified course to a new category
        ...
        if (!empty($deletecourses) and $data = data_submitted() and confirm_sesskey()) {   // Some courses are being moved
