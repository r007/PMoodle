<?php
// === Get root path ==========================================================
  $path_array = explode("\\us_phpmyadmin",dirname(__FILE__)); // Split at folder
  $root       = substr($path_array[0],0,-5);   // Get path e.g C:\..\UniServer

// === Get MySQL Port =========================================================
// Get MySQL Port from configuration file

  $my_ini_file    = $root."\usr\local\mysql\my.ini";     // Path to my ini file
...
// Get MySQL Password from file
  $password_file  = $root."\uni_con\includes\mysql_password"; // Path to file
  ...
  $password  = trim($password);                        // Remove new line
