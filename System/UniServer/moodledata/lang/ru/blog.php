...
/**
 * Strings for component 'blog', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   blog
...
$string['associationunviewable'] = 'Эта запись не может быть просмотрена другими до тех пор, пока с ней не будет ассоциирован курс или не будет изменено поле "Опубликовать в"';
$string['autotags'] = 'Добавить эти теги';
$string['autotags_help'] = 'Введите один или несколько локальных тегов (через запятую), которые Вы хотите автоматически добавлять в своём локальном блоге к каждой записи, скопированной из внешнего блога.';
...
$string['blog'] = 'Блог';
$string['blogaboutthis'] = 'Блог о б этом модуле типа "{$a->type}"';
...
$string['externalblogdeleted'] = 'Внешний блог удалён';
...
$string['name_help'] = 'Введите описательное имя своего внешнего блога. (Если имя не указано, то будет использоваться название Вашего внешнего блога).';
...
$string['publishto'] = 'Опубликовать в';
...
$string['url'] = 'Адрес (URL)';
$string['url_help'] = 'Введите адрес RSS-ленты вашего внешнего блога.';
...
$string['viewmyentriesaboutcourse'] = 'Просмотр мои записи об этом курсе';
