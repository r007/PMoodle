...
/**
 * Strings for component 'plugin', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   plugin
...
$string['nonehighlighted'] = 'Нет плагинов, требующих внимания при этом обновлении';
...
$string['pluginchecknotice'] = 'На этой странице отображаются плагины, которые могут потребовать особого внимания в процессе обновления. Выделены новые плагины, которые сейчас будут установлены; обновляемые плагины, которые будут обновлены, а также отсутствующие ранее установленные плагины. Также отмечены плагины сторонних разработчиков. Мы рекомендуем Вам проверить, существуют ли более свежие версии плагинов сторонних разработчиков и обновить их исходный код перед продолжением этого обновления Moodle.';
...
$string['somehighlighted'] = 'Количество плагинов, требующих внимания при этом обновлении: {$a}';
$string['somehighlightedinfo'] = 'Показать полный список установленных плагинов';
$string['source'] = 'Источник';
$string['sourceext'] = 'Дополнительный';
...
$string['status_upgrade'] = 'Будет обновлён';
$string['status_uptodate'] = 'Последняя версия';
...
$string['type_coursereport'] = 'Отчёт курса';
$string['type_coursereport_plural'] = 'Отчёты по курсам';
...
$string['type_gradereport'] = 'Отчёт журнала оценок';
$string['type_gradereport_plural'] = 'Отчёты журнала оценок';
$string['type_local'] = 'Локальный плагин';
$string['type_local_plural'] = 'Локальные плагины';
$string['type_message'] = 'Обработчик сообщений';
$string['type_message_plural'] = 'Обработчики сообщений';
