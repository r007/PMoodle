...
/**
 * Strings for component 'hub', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   hub
...
$string['contributornames_help'] = 'Вы можете использовать это поле, чтобы перечислить имена тех, кто внёс вклад в разработку курса.';
...
$string['educationallevel'] = 'Уровень образования';
$string['educationallevel_help'] = 'Выберите уровень образования, которому более всего соотвествует курс.';
...
$string['errorregistration'] = 'Во время регистрации произошла ошибка, пожалуйста, попробуйте ещё раз позже. ({$a})';
...
$string['publishername_help'] = 'Издатель - человек или организация, являющиеся официальным издателем курса. Если Вы не издаёте курс от чьего-то имени, то издателем будете Вы.';
...
$string['sendingsize'] = 'Пожалуйста, подождите. Идёт загрузка файла курса в каталог ({$a->total} Мб)...';
$string['sent'] = '...завершено';
$string['settings'] = 'Настройки';
$string['share'] = 'Поделиться курсом с другими людьми, предоставив возможность его скачать.';
$string['shared'] = 'Размещён файл';
...
$string['unpublishalladvertisedcourses'] = 'Убрать из каталога все размещённые там ссылки на курсы';
