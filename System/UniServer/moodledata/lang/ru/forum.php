...
/**
 * Strings for component 'forum', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   forum
...
$string['maxattachments'] = 'Максимальное число прикреплённых файлов';
...
$string['maxattachmentsize_help'] = '<p align="center"><h2>Максимальный размер вложенного файла</h2></p>

<p>Эта установка позволяет задать максимальный размер загружаемого файла.</p>

<p>При загрузке файла большего размера, чем задано, вы получите сообщение об ошибке.</p>';
...
$string['postrating1'] = 'Наиболее отделённые сообщения';
$string['postrating2'] = 'Отделённые и связанные сообщения';
