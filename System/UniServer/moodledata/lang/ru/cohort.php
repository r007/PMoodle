...
/**
 * Strings for component 'cohort', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   cohort
...
$string['external'] = 'Внешняя глобальная группа';
...
$string['removeuserwarning'] = 'Удаление пользователей из глобальной группы может привести к отчислению пользователей из нескольких курсов, что приведёт к удалению пользовательских настроек, оценок, членства в группах и других сведений о пользователе из затронутых курсов.';
