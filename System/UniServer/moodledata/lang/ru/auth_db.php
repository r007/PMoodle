...
/**
 * Strings for component 'auth_db', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbsuspenduser'] = 'Заблокирован пользователь "{$a->name}" id {$a->id}';
