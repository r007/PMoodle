...
/**
 * Strings for component 'theme_formal_white', language 'ru', branch 'MOODLE_22_STABLE'
 *
...
$string['blockcontentbgcdesc'] = 'Этот параметр задаёт цвет фона содержимого блоков.';
...
$string['frontpagelogo'] = 'Пользовательский логотип для главной страницы';
$string['frontpagelogodesc'] = 'Можно изменить логотип, используемый этой темой на главной странице, указав URL нового (например: http://www.yoursite.local/myfrontpagelogo.png). По умолчанию используется логотип шириной 300 и высотой 80 пикселей. Лучше использовать PNG-файл c прозрачным фоном.';
$string['headerbgc'] = 'Цвет фона заголовков блоков';
$string['headerbgcdesc'] = 'Параметр задаёт цвет фона заголовков блоков для этой темы.';
$string['heading'] = 'Отображать заголовок страницы';
$string['lblockcolumnbgc'] = 'Цвет фона левой колонки';
$string['lblockcolumnbgcdesc'] = 'Параметр задаёт цвет фона левой колонки для этой темы.';
$string['logo'] = 'Пользовательский логотип';
$string['logodesc'] = 'Можно изменить логотип, используемый этой темой, указав URL нового (например: http://www.yoursite.local/mylogo.png). По умолчанию используется логотип шириной 200 и высотой 50 пикселей. Лучше использовать PNG-файл c прозрачным фоном.';
