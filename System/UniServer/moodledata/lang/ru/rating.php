...
/**
 * Strings for component 'rating', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   rating
...
$string['aggregatetype'] = 'Метод расчёта итога';
...
$string['capabilitychecknotavailable'] = 'Невозможно проверит назначение права до сохранения элемента курса';
