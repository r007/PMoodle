...
/**
 * Strings for component 'group', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   group
...
$string['evenallocation'] = 'Примечание: чтобы сохранить распределение группы, даже если фактическое количество её участников отличается от указанного Вами числа.';
...
Групповой режим, определённый на уровне курса, является режимом по умолчанию для всех элементов, создаваемых в курсе. Для каждого элемента, поддерживающего групповой режим, можно можно указать его собственный групповой режим. Если в курсе установлен принудительный групповой режим, то установки группового режима для любого элемента курса игнорируются.';
...
$string['nogroups'] = 'В курсе ещё нет групп';
