...
/**
 * Strings for component 'scorm', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   scorm
...
$string['grademethod_help'] = 'Метод оценивания задаёт, как определяется оценка отдельной попытки.
...
$string['lastattemptlock_help'] = 'Если параметр включен, то студент не может запустить проигрыватель SCORM после израсходования им всех разрешённых попыток.';
...
$string['preferencesuser'] = 'Настройки отчёта';
