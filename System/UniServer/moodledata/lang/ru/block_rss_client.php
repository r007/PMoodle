...
/**
 * Strings for component 'block_rss_client', language 'ru', branch 'MOODLE_22_STABLE'
 *
...
$string['clientnumentries'] = 'Количество записей по умолчанию, показываемых для каждой ленты.';
...
$string['customtitlelabel'] = 'Своё название (оставьте пустым для использования заголовка, указанного в ленте):';
...
$string['editfeeds'] = 'Редактировать, подписаться/отписаться от RSS/Atom новостной ленты';
...
$string['feedurl'] = 'Адрес ленты';
$string['findmorefeeds'] = 'Искать ещё RSS-ленты';
$string['managefeeds'] = 'Редактировать все мои ленты';
$string['nofeeds'] = 'Для вашего сайта не определено ниодной RSS ленты.';
$string['pluginname'] = 'Клиент RSS';
$string['remotenewsfeed'] = 'Отдаленная новостная лента';
