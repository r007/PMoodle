...
/**
 * Strings for component 'completion', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   completion
...
$string['completedwarningtext'] = 'Один или несколько студентов ({$a}) уже завершили этот элемент. Изменение настроек приведёт к удалению их достижений и может ввести пользователей в заблуждение. В связи с этим данные настройки были заблокированы. Не следует их разблокировать без крайней необходимости.';
...
$string['completionexpected_help'] = 'Данная настройка определяет дату, когда элемент курса ориентировочно должен быть выполнен. Эта дата не отображается для студентов, и выводится только в отчёте о выполнении элемента.';
$string['completion_help'] = 'Если параметр включён, то будет отслеживаться (вручную или автоматически) завершение элементов курса, основываясь на определённых условиях. Можно устанавливать несколько условий, но в этом случае элемент будет считаться завершённым при выполнении ВСЕХ условий.

Отметка рядом с названием элемента на странице курса показывает, что элемент завершён.';
...
$string['coursecomplete'] = 'Курс завершён';
$string['coursecompleted'] = 'Курс завершён';
...
$string['remainingenroledfortime'] = 'Оставаться зарегистрированным в течение определённого периода времени';
...
$string['viewcoursereport'] = 'Просмотреть отчёт по курсу';
