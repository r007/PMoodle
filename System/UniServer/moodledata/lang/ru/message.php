...
/**
 * Strings for component 'message', language 'ru', branch 'MOODLE_22_STABLE'
 *
 * @package   message
...
$string['backupmessageshelp'] = 'Если включено, обмен сообщениями будет включён в автоматическое резервирование сайта';
...
$string['disabled'] = 'Сообщения отключены на этом сайте';
...
$string['mailsent'] = 'Ваше сообщение отправлено по e-mail';
...
$string['notpermitted'] = 'Не разрешено';
...
$string['outputnotavailable'] = 'Не доступно';
