...
/**
 * Strings for component 'tool_customlang', language 'ru', branch 'MOODLE_22_STABLE'
 *
...
$string['headinglocal'] = 'Локальное перевод';
$string['headingstandard'] = 'Стандартное текст';
