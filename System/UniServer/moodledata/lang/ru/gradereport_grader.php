...
/**
 * Strings for component 'gradereport_grader', language 'ru', branch 'MOODLE_22_STABLE'
 *
...
$string['grader:manage'] = 'Настроить отчёт по оценкам';
$string['grader:view'] = 'Просмотреть отчёт по оценкам';
$string['pluginname'] = 'Отчёт по оценкам';
$string['preferences'] = 'Настройки отчёта по оценкам';
