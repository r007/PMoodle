...
/**
 * Strings for component 'report_security', language 'ru', branch 'MOODLE_22_STABLE'
 *
...
$string['check_emailchangeconfirmation_info'] = 'Пользователи могут вводить адреса электронной почты только из разрешённых доменов.';
...
$string['check_google_details'] = '<p>Установка Открыть для Google позволяет поисковым машинам входить в курсы с доступом гостя. Нет никакого смысла в этой настройке, если вход гостя не разрешён.</p>';
$string['check_google_error'] = 'Доступ поисковой машины разрешён, но доступ гостя - запрещён.';
...
$string['check_mediafilterswf_name'] = 'Медиа-фильтр .swf (Flash) включён';
...
$string['check_noauth_ok'] = 'Метод <em>Не использовать аутентификацию</em> отключён.';
...
$string['check_passwordpolicy_details'] = '<p>Рекомендуется, чтобы была установлена политика паролей, так как угадывание пароля - часто самый лёгкий способ получить несанкционированный доступ. Не делайте требования слишком строгими, поскольку это может привести к тому, что пользователи не смогут запомнить свои пароли и будут забывать или записывать их. </p>';
...
$string['check_unsecuredataroot_error'] = 'Ваш каталог dataroot<code>{$a}</code> неправильно размещён и доступен из сети!';
...
$string['check_unsecuredataroot_warning'] = 'Ваш каталог dataroot<code>{$a}</code> неправильно размещён и, возможно, доступен из сети!';
...
$string['statusok'] = 'OK';
$string['statusserious'] = 'Серьёзное';
